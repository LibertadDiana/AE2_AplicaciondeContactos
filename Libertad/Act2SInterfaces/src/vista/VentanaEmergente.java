...
public class VentanaEmergente extends JDialog {
	...
	public VentanaEmergente(DefaultTableModel modelo) {
		...
		ManejadorEventosEmergente manejador = new ManejadorEventosEmergente(this);
	...
	public void establecerManejador(ManejadorEventosEmergente manejador) {
